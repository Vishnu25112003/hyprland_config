      ...
      await logicContract.methods
        ...
        .on("receipt", function (receipt: any) {
          ...
          if (safeReceipt.status) {
            ...
            // ✅ WALLET-SCOPED STORAGE: Save multiple guesses in wallet-specific localStorage
            const storageKey = getWalletStorageKey("allGuessSubmissions", registeredWallet);
            const existingGuessesRaw = localStorage.getItem(storageKey);
            ...
            // ✅ WALLET-SCOPED: Also save last guess submission with wallet scope
            const lastGuessKey = getWalletStorageKey("lastGuessSubmission", registeredWallet);
            localStorage.setItem(
              lastGuessKey,
