...
// ✅ FIXED CODE (with proper type casting)
targetBlockNum = safeToNumber(
  entry.targetBlockNumber ?? (entry as any)['0']
);
targetVerifiedNum = safeToNumber(
  entry.targetVerified ?? (entry as any)['1']
);
        }
